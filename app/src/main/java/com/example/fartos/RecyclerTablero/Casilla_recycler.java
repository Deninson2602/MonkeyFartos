...
public class Casilla_recycler extends RecyclerView.Adapter<Casilla_adapter> {

    private List<Casilla> casillas;
    private Context context;
    List<TextView> jugadores;

    public Casilla_recycler(List<Casilla> casillas) {
        this.casillas = casillas;
    }

    public Casilla_recycler(List<Casilla> casillas, Context context) {
        this.casillas = casillas;
    ...
    @NonNull
    @Override
    public Casilla_adapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View vista = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_tres_jugadores, parent, false);
        final Casilla_adapter viewHolder = new Casilla_adapter(vista);
    ...
    @Override
    public void onBindViewHolder(@NonNull Casilla_adapter holder, @SuppressLint("RecyclerView") int position) {
